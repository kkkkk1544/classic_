...
<title>상품 리스트</title>
	...
	<c:forEach items="${faqList}" var="FaqDTO">
		<div>
			<a class="num-link" href="list.do?num=${FaqDTO.num}">
	...
	<div>
		<a class="num-text" href="list.do?num=${FaqDTO.num}">
			<th>글목록입니다</th>
			<tr>
		</a>
	</div>
	...
	<c:forEach items="${faqList}" var="FaqDTO">
		<div>
			<a class="page-link" href="list.do?num=${FaqDTO.num}">
				<th>이것은 faq글 이다</th>
				
				
				
				<a class="page-link" href="list.do?num=${FaqDTO.mem_num}">
				</a>
	...
	<div>
		<a class="page-text" href="list.do?num=${FaqDTO.num}">
			<th>글목록입니다</th>
			<tr>
		</a>
	</div>
