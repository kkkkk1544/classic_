		...
		<form name="joinForm" method="post" action="/join.do">
			<div class="join_body">
				<div class="table-responsive">
					<table class="table">
						<tr>
							<th class="col-xs-2" style="text-align: right;">아이디<small style="color: red;">*</small></th>
							<td>
						...
						<tr>
							<th class="col-xs-2" style="text-align: right;">비밀번호<small style="color: red;">*</small></th>
							<td>
								<div class="form-group">
									<div class="col-xs-6">
						...
						<tr>
							<th class="col-xs-2" style="text-align: right;">비밀번호 확인<small style="color: red;">*</small></th>
							<td>
								<div class="form-group">
									<div class="col-xs-6">
						...
						<tr>
							<th class="col-xs-2" style="text-align: right;">연락처</th>
							<td>
								<div class="form-group">
									<div class="col-xs-6">
						...
						<tr>
							<th class="col-xs-2" style="text-align: right;">이메일<small style="color: red;">*</small></th>
							<td>
								<div class="form-group">
									<div class="col-xs-6">
			...
			<div class="user_agree_body">
				<div class="agree_left">
					...
					<div class="user_agree_contents">
						...
						<p>제9조(구매신청) <br>① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.<br>&nbsp; 1. 재화 등의 검색 및 선택<br>&nbsp; 2. 받는 사람의 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호) 등의 입력<br>&nbsp; 3. 약관내용, 청약철회권이 제한되는 서비스, 배송료,<span style="font-size: 9pt;">설치비 등의 비용부담과 관련한 내용에 대한 확인</span></p>
						<p>&nbsp; 4. 이 약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시(예, 마우스 클릭)<br>&nbsp; 5. 재화등의 구매신청 및 이에 관한 확인 또는 “몰”의 확인에 대한 동의<br>&nbsp; 6. 결제방법의 선택<br>② “몰”이 제3자에게 구매자 개인정보를 제공,위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유,<span style="font-size: 9pt;">이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.</span></p>
						...
						<p>제18조(“몰“의 의무)<br>① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화와 용역을 제공하는데 최선을 다하여야 합니다.<br>② “몰”은 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.<br>③ “몰”이 상품이나 용역에 대하여 「표시 광고의 공정화에 관한 법률」 제3조 소정의 부당한 표시된 광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 집니다.<br>④ “몰”은 이용자가 원하지 않는 영리목적의 광고성 전자우편을 발송하지 않습니다.</p>
						...
						<p><br></p>부 칙(시행일) 이 약관은 2016 년 09 월 01 일부터 시행합니다.
						<div>변경이력</div>
						<div>이 약관은 2017 년 12 월 02 일부터 시행하며 종전의 약관은 이 약관으로 대체 합니다.</div>
					</div>
				</div>
