	...
	<p class="comu_title">NOTICE</p>
		...
		<form name="noticeRegisterForm method=post action="">
			...
			<div class="notice_btn_group">
				<button type="submit" class="btn btn-default btn-lg" onclick="location.href='<c:url value='/comu/notice/adminView.jsp'/>'">수정</button>
				<button type="reset" class="btn btn-default btn-lg" onclick="location.href='<c:url value='/comu/notice/adminlist.jsp'/>'">삭제</button>
			</div>
		</form>
	</div>
</div>
